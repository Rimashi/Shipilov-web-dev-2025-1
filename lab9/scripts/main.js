...
window.fcUtils = {
    ...
    // Получение существительного в правильной форме
    ...
    // Преобразование категории в русское название
    getRuCategory: (category) => {
        const categories = {
            "soup": "Супы",
            "main-course": "Горячее",
            "salad": "Салаты",
    ...
    // Преобразование типа в русское название
    getRuType: (type) => {
        const types = {
            "veg": "Веганское",
            "meat": "Мясное",
    ...
    // Получить все типы для категории
    getAllTypesForCategory: (menuList) => {
